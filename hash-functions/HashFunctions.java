...
public class HashFunctions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "La clé de 100 est : " + e.getKey(100) + ", elle est presente: " + e.containsKey(e.getKey(100)));
        System.out
                .println("La clé de 99 est : " + e.getKey(99) + ", elle est presente: " + e.containsKey(e.getKey(99)));
        System.out.println(
                "La clé de 200 est : " + e.getKey(200) + ", elle est presente: " + e.containsKey(e.getKey(200)));
        System.out.println(
                "La clé de 199 est : " + e.getKey(199) + ", elle est presente: " + e.containsKey(e.getKey(199)));
        System.out.println(
                "La clé de 300 est : " + e.getKey(300) + ", elle est presente: " + e.containsKey(e.getKey(300)));
        System.out.println(
                "La clé de 299 est : " + e.getKey(299) + ", elle est presente: " + e.containsKey(e.getKey(299)));
        System.out.println();
        ...
        System.out.println("La clé de 100 est : " + pfhash.getKey(100) + ", elle est presente: "
                + pfhash.containsKey(pfhash.getKey(100)));
        System.out.println("La clé de 99 est : " + pfhash.getKey(99) + ", elle est presente: "
                + pfhash.containsKey(pfhash.getKey(99)));
        System.out.println("La clé de 200 est : " + pfhash.getKey(200) + ", elle est presente: "
                + pfhash.containsKey(pfhash.getKey(200)));
        System.out.println("La clé de 199 est : " + pfhash.getKey(199) + ", elle est presente: "
                + pfhash.containsKey(pfhash.getKey(199)));
        System.out.println("La clé de 300 est : " + pfhash.getKey(300) + ", elle est presente: "
                + pfhash.containsKey(pfhash.getKey(300)));
        System.out.println("La clé de 299 est : " + pfhash.getKey(299) + ", elle est presente: "
    ...
    public static ArrayList<Integer> randomIntegers(int length) {
        Random generateur = new Random(System.nanoTime());
        ArrayList<Integer> res = new ArrayList<Integer>();
        for (int i = 0; i < length; i++) {
            int val = 0;
            do{
                val = generateur.nextInt(p);
