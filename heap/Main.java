...
public class Main 
{
   ...
   public static void main(String[] args) 
   {
      ...
      Integer headHeap = heap.poll();
      Integer head = prq.poll();
      System.out.println("Tete du monceau : "+ headHeap);
      System.out.println("Monceau après poll: "+ heap);
      
      System.out.println("Tete de la queue : "+ head);
      System.out.println("PriorityQueue après poll: "+ prq);
      
   // TEST 2
      
      Iterator it = prq.iterator();
      System.out.println("Valeurs PriorityQueue: ");  
      while (it.hasNext()) {
         System.out.println("Valeur: "+ it.next()); 
      }
      Iterator itH = heap.iterator();
      System.out.println("Valeurs monceau: "); 
      while (itH.hasNext()) {
          System.out.println("Valeurs monceau: "+ itH.next()); 
       }
      //FIN DES TESTS
   }
